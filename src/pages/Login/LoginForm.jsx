...
const LoginForm = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center w-full max-w-5xl mx-auto text-white my-16 px-4 sm:px-6 md:px-8">
      <div className="relative overflow-hidden bg-[url('/assets/texture.jpg')] bg-center bg-cover flex flex-col justify-center items-center text-center bg-neutral-900 border border-neutral-700 p-6 sm:p-10 md:p-16 rounded-lg gap-4 w-full max-w-5xl">
        ...
        {/* Input fields */}
        <motion.div className="flex flex-col md:flex-row gap-6 w-full justify-center items-center">
          <motion.input
            id="email"
            required
            type="email"
